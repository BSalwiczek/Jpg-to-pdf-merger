...
var LinearProgress = /*#__PURE__*/external_react_.forwardRef(function LinearProgress(props, ref) {
  ...
  return /*#__PURE__*/external_react_.createElement("div", _extends({
    className: external_clsx_default()(classes.root, classes["color".concat(capitalize(color))], className, {
    ...
    ref: ref
  }, other), variant === 'buffer' ? /*#__PURE__*/external_react_.createElement("div", {
    className: external_clsx_default()(classes.dashed, classes["dashedColor".concat(capitalize(color))])
  }) : null, /*#__PURE__*/external_react_.createElement("div", {
    className: external_clsx_default()(classes.bar, classes["barColor".concat(capitalize(color))], (variant === 'indeterminate' || variant === 'query') && classes.bar1Indeterminate, {
      'determinate': classes.bar1Determinate,
      'buffer': classes.bar1Buffer
    }[variant]),
    style: inlineStyles.bar1
  }), variant === 'determinate' ? null : /*#__PURE__*/external_react_.createElement("div", {
    className: external_clsx_default()(classes.bar, (variant === 'indeterminate' || variant === 'query') && classes.bar2Indeterminate, variant === 'buffer' ? [classes["color".concat(capitalize(color))], classes.bar2Buffer] : classes["barColor".concat(capitalize(color))]),
    style: inlineStyles.bar2
  }));
});
 false ? 0 : void 0;
/* harmony default export */ var LinearProgress_LinearProgress = (styles_withStyles(styles, {
